...
//     version 1.14.2
//     from Assets/Takamori/InputActions/JoinInput.inputactions
//
...
/// <summary>
/// Provides programmatic access to <see cref="InputActionAsset" />, <see cref="InputActionMap" />, <see cref="InputAction" /> and <see cref="InputControlScheme" /> instances defined in asset "Assets/Takamori/InputActions/JoinInput.inputactions".
/// </summary>
/// <remarks>
...
/// </code>
/// </example>
public partial class @JoinInput: IInputActionCollection2, IDisposable
{
    /// <summary>
    ...
    ""maps"": [
        {
            ""name"": ""Join"",
            ""id"": ""f0a81ce6-3b90-46c2-9434-b05c00354342"",
            ""actions"": [
                {
                    ""name"": ""Join"",
                    ""type"": ""Button"",
                    ""id"": ""3519773b-3ea5-4df0-9f96-b4d21c63935f"",
                    ""expectedControlType"": """",
                    ""processors"": """",
                    ""interactions"": """",
            ...
            ""bindings"": [
                {
                    ""name"": """",
                    ""id"": ""4b426131-4820-4ca6-8342-4803c0a4cf6b"",
                    ""path"": ""<Keyboard>/enter"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": """",
                    ""id"": ""020b982f-5cb8-4a56-b7fe-6016e26b4f31"",
    ...
    ~@JoinInput()
    {
        UnityEngine.Debug.Assert(!m_Join.enabled, "This will cause a leak and performance issues, JoinInput.Join.Disable() has not been called.");
    }
    ...
    {
        private @JoinInput m_Wrapper;

        /// <summary>
        /// Construct a new instance of the input action map wrapper class.
        /// </summary>
        public JoinActions(@JoinInput wrapper) { m_Wrapper = wrapper; }
        /// <summary>
